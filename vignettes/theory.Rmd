...
Theory is that an FID is a mass sensitive detector. An atmospheric premixed laminar 
...
$$V \propto \eta_c \dot{n} = \eta_c\left( r_{br}  \frac{x_CM_C}{M_G} \right) \left(F_d  \frac{P M_G}{RT} \right)$$
where:

$r_{br}$: branching ratio; total ion formation rate divided by global reaction rate
...
The expression in the left bracket gives the mass ratio of ions formed in the burning 
feed gas, while the expression in the right bracket represents the mass flow rate into
the jet.

Ions and electrons are produced in equal amounts. An inhomogeneous electric field 
...
It is well known that an FID will saturate at high analyte 
concentrations. This saturation is caused by a space charge effect. When a massive 
amount of ions is generated, they partially shield the electric field and slow 
down the migration speed of the ions. So ions and electrons have more time to recombine and 
the detector sensitivity decreases.

Pressure primarily affects the flame geometry, but in a complicated way.
![flame_geometry.jpg](./img/flame_geometry.jpeg)
