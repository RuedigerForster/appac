...
increases inversely proportional with pressure. Our measurements, however, show 
that the sensitivity of a TCD typically changes at a rate of about -0.5% per 10hPa 
of pressure increase, which is only half of the expected rate.
...
on detector response is a negative one. The rate of response change per pressure 
change is +1.0% per 10hPa pressure increase. Injecting a gaseous sample at atmospheric 
