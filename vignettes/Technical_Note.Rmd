...
flow rate.  
Instruments having manual pneumatics, provide a constant volumetric flow rate 
...
Can someone please check the above note experimentally? Thank you.
</span>
...
The quadratic tern in eq. (8) is only used in this early stage of the calculation. 
In the further course of the algorithm, a linear fit is sufficient.
...
autocorrelation in the measurement series. The autocorrelation in the data must be
...
extreme cases several modes appear, see Fig. 1.
